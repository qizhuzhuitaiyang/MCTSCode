...
from .dataset_mimic import MIMICDrugDataset

dataset_choices = {'text8_256', 'enwik8_blocksparse', 'mimic_drugs'}
...
def get_data(args):
    ...
    if args.dataset == 'text8_256':
        ...
        data_shape = (320,)
        num_classes = 256
    elif args.dataset == 'mimic_drugs':
        train = MIMICDrugDataset(split='train')
        valid = MIMICDrugDataset(split='valid')
        test = MIMICDrugDataset(split='test')
        data_shape = (190,)  # 190 ATC level 3 drugs
        num_classes = 3      # 0=not prescribed, 1=prescribed, 2=MASK
